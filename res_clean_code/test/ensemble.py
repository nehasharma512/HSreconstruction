...
base_path = '/home/neha512/res_clean_code/test'

mat_path1 = base_path+'/test_results1'
mat_path2 = base_path+'/test_results2'
mat_path3 = base_path+'/test_results3'
save_path = base_path+'/final_results'
